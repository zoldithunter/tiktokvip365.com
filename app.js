...
async function mockData() {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve({
        packages: [
          { id: 1, coins: 350, price: 100000 },
          { id: 2, coins: 700, price: 200000 },
          { id: 3, coins: 1400, price: 400000 },
          { id: 4, coins: 3500, price: 1000000 },
          { id: 5, coins: 7000, price: 2000000 },
          { id: 6, coins: 17500, price: 5000000 },
          { id: 7, coins: 35000, price: 10000000 },
          { id: 8, coins: 70000, price: 20000000 },
        ],
        custom: { min: 50, max: 1000000, rate: 286 },
      });
    }, 500);
  });
}
...
function renderPackages(packages) {
  ...
  packages.forEach((pkg) => {
    ...
    card.innerHTML = `
      ...
      <h3>${pkg.coins.toLocaleString()} Coin</h3>
